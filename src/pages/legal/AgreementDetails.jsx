    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Agreement ID: {agreement.id}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <p className="text-sm text-gray-700"><strong>Client:</strong> {agreement.client}</p>
          <p className="text-sm text-gray-700"><strong>Amount:</strong> {agreement.amount}</p>
          <p className="text-sm text-gray-700"><strong>Submitted Date:</strong> {agreement.submittedDate}</p>
          <p className="text-sm text-gray-700"><strong>Priority:</strong> {agreement.priority}</p>
          ...
          <p className="text-sm text-gray-700"><strong>Assigned To:</strong> {agreement.assignedTo}</p>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="text-lg font-semibold text-blue-900 mb-2">Legal Review Guidelines</h3>
